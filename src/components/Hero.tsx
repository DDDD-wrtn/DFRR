...
export default function HeroSection() {
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center pt-20 pb-24 overflow-hidden border-b border-crimson/20">
      <img src="https://i.postimg.cc/gJ6gZbc0/jemog-eobsneun-dijain-(6).png" alt="Hero Background" className="absolute top-0 left-0 w-full h-full object-cover opacity-60" referrerPolicy="no-referrer" />
      <div className="absolute inset-0 bg-gradient-to-b from-deep-black/20 via-deep-black/80 to-deep-black"></div>
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 flex flex-col items-center text-center">
        ...
        >
          <p className="text-crimson font-serif tracking-[0.3em] uppercase text-sm mb-4">Dark Fantasy Romance RPG</p>
          <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold text-white mb-6 leading-tight drop-shadow-2xl font-serif">
            마왕의 딸과<br />
            <span className="text-crimson">정략결혼</span>을 해버렸다
          </h1>
          <p className="text-base sm:text-lg md:text-2xl text-silver mb-12 max-w-3xl leading-relaxed">
        ...
        >
          ...
          <div className="flex overflow-x-auto gap-4 pb-4 justify-center py-4 px-2">
            {prologues.map((item, idx) => (
              <div 
                key={idx} 
                className="shrink-0 w-[260px] md:w-[360px] aspect-[4/5] overflow-hidden rounded-sm border border-crimson/20 shadow-[0_0_15px_rgba(139,0,0,0.1)] relative"
              >
